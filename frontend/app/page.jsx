...
function LoginModal({ onClose }) {
  return (
    <div
      ...
      style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.52)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, padding: "20px", backdropFilter: "blur(6px)", animation: "sk-fadeIn .22s ease" }}
    >
...
function GalleryPopup({ item, onClose }) {
  return (
    <div
      onClick={e => e.target === e.currentTarget && onClose()}
      style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.58)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9998, padding: "20px", backdropFilter: "blur(10px)", animation: "sk-fadeIn .22s ease" }}
    >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              <Link href="/register" style={{ padding: "13px 30px", borderRadius: "8px", background: "linear-gradient(135deg,#C41E3A,#8B0020)", color: "#fff", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>Start Your Journey →</Link>
      ...
      <section ref={secRef("srv")} style={{ background: "#f8f8f8", padding: "100px 48px", opacity: vis("srv") ? 1 : 0, transform: vis("srv") ? "none" : "translateY(40px)", transition: "all .7s ease" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "56px" }}>
            <div style={{ display: "inline-block", padding: "6px 14px", borderRadius: "99px", background: "rgba(196,30,58,.06)", border: "1px solid rgba(196,30,58,.15)", fontSize: "11px", fontWeight: 600, color: "#C41E3A", letterSpacing: ".14em", textTransform: "uppercase", marginBottom: "16px", fontFamily: "'DM Sans',sans-serif" }}>What We Offer</div>
      ...
      <section ref={secRef("gal")} style={{ padding: "100px 48px", background: "#fff", opacity: vis("gal") ? 1 : 0, transform: vis("gal") ? "none" : "translateY(40px)", transition: "all .7s ease" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "44px", flexWrap: "wrap", gap: "20px" }}>
            <div>
              <div style={{ display: "inline-block", padding: "6px 14px", borderRadius: "99px", background: "rgba(196,30,58,.06)", border: "1px solid rgba(196,30,58,.15)", fontSize: "11px", fontWeight: 600, color: "#C41E3A", letterSpacing: ".14em", textTransform: "uppercase", marginBottom: "14px", fontFamily: "'DM Sans',sans-serif" }}>Product Gallery</div>
              ...
              <p style={{ fontSize: "15px", color: "#777", marginTop: "10px", fontFamily: "'DM Sans',sans-serif" }}>
                Click any product to preview. <strong style={{ color: "#C41E3A" }}>Prices visible to registered sellers only.</strong>
              </p>
            </div>
          ...
          <div style={{ marginTop: "32px", padding: "18px 24px", borderRadius: "14px", background: "#fafafa", border: "1px solid #f0f0f0", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "14px" }}>
            ...
            <Link href="/register" style={{ padding: "11px 26px", borderRadius: "8px", background: "linear-gradient(135deg,#C41E3A,#8B0020)", color: "#fff", fontSize: "13px", fontWeight: 600, textDecoration: "none", boxShadow: "0 6px 20px rgba(196,30,58,.22)", fontFamily: "'DM Sans',sans-serif" }}>Register to Unlock →</Link>
          </div>
        </div>
      </section>
          ...
          <div style={{ marginTop: "48px", borderRadius: "20px", background: "linear-gradient(135deg,#111 0%,#1e0508 50%,#2d0b18 100%)", padding: "52px 48px", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{ display: "flex", gap: "14px", justifyContent: "center", flexWrap: "wrap" }}>
                <Link href="/register" style={{ padding: "14px 36px", borderRadius: "8px", background: "linear-gradient(135deg,#C41E3A,#8B0020)", color: "#fff", fontSize: "14px", fontWeight: 600, letterSpacing: ".08em", textDecoration: "none", boxShadow: "0 12px 32px rgba(196,30,58,.4)", fontFamily: "'DM Sans',sans-serif" }}>Register as Seller →</Link>
