...
// ── TAG PILL ──────────────────────────────────────────────────
const Tag = ({ children }) => (
  <div style={{ display:"inline-block", padding:"6px 14px", borderRadius:"99px", background:"rgba(107,26,42,.06)", border:"1px solid rgba(107,26,42,.18)", fontSize:"11px", fontWeight:600, color:BURG, letterSpacing:".14em", textTransform:"uppercase", marginBottom:"18px", fontFamily:"'DM Sans',sans-serif" }}>
    {children}
  </div>
);
  ...
  return (
    <div onClick={e => e.target === e.currentTarget && onClose()} style={{ position:"fixed",inset:0,background:"rgba(0,0,0,.52)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:9999,padding:"20px",backdropFilter:"blur(6px)",animation:"sk-fadeIn .22s ease" }}>
      <div style={{ background:"#fff",borderRadius:"20px",padding:"48px 40px",width:"100%",maxWidth:"420px",textAlign:"center",boxShadow:"0 32px 80px rgba(0,0,0,.18)",animation:"sk-slideUp .28s ease",position:"relative" }}>
        ...
        <div style={{ width:"60px",height:"60px",borderRadius:"50%",background:GRAD,margin:"0 auto 20px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"24px" }}>🎬</div>
        ...
        <p style={{ fontFamily:"'DM Sans',sans-serif",fontSize:"15px",color:"#666",lineHeight:1.7,marginBottom:"30px" }}>
          Sign in to your verified seller account to watch full training videos.
        </p>
        <div style={{ display:"flex",flexDirection:"column",gap:"12px" }}>
          <Link href="/login" style={{ display:"block",padding:"14px",borderRadius:"10px",background:GRAD,color:"#fff",fontSize:"14px",fontWeight:600,textDecoration:"none",fontFamily:"'DM Sans',sans-serif" }}>
            Sign In to Watch →
          </Link>
        ...
        <div style={{ padding:"24px 28px 28px" }}>
          ...
          <div style={{ background:"#fafafa",border:"1px solid #f0f0f0",borderRadius:"12px",padding:"14px 16px",marginBottom:"18px" }}>
            ...
            <div style={{ display:"flex",alignItems:"center",gap:"10px" }}>
              ...
              <span style={{ fontSize:"11px",padding:"3px 9px",borderRadius:"6px",background:"rgba(107,26,42,.07)",color:BURG,fontWeight:600,border:"1px solid rgba(107,26,42,.15)",fontFamily:"'DM Sans',sans-serif" }}>🔒 Login to View</span>
            </div>
          </div>
          <div style={{ display:"flex",gap:"10px" }}>
            <Link href="/login" style={{ flex:1,padding:"13px",borderRadius:"10px",background:GRAD,color:"#fff",fontSize:"13px",fontWeight:600,textDecoration:"none",textAlign:"center",fontFamily:"'DM Sans',sans-serif" }}>Login to Order →</Link>
    ...
    <div style={{ fontFamily:"'DM Sans',sans-serif",background:"#fff",color:"#111",overflowX:"hidden" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .sk-srv:hover { border-color:rgba(107,26,42,.25)!important; transform:translateY(-5px)!important; box-shadow:0 16px 40px rgba(107,26,42,.08)!important; }
        ...
        .sk-vid:hover { border-color:rgba(107,26,42,.25)!important; transform:translateY(-4px)!important; }
        .sk-feat:hover { background:#fff!important; border-color:rgba(107,26,42,.2)!important; box-shadow:0 8px 24px rgba(107,26,42,.07)!important; }
      `}</style>
      ...
      <section style={{ minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"120px 48px 80px",background:"#fff",position:"relative",overflow:"hidden",textAlign:"center" }}>
        {/* subtle grid */}
        <div style={{ position:"absolute",inset:0,backgroundImage:"linear-gradient(rgba(107,26,42,.015) 1px,transparent 1px),linear-gradient(90deg,rgba(107,26,42,.015) 1px,transparent 1px)",backgroundSize:"48px 48px",pointerEvents:"none" }} />
        {/* glow — mix of burgundy + gold */}
        <div style={{ position:"absolute",top:"20%",left:"30%",width:"500px",height:"400px",background:"radial-gradient(ellipse,rgba(107,26,42,.06) 0%,transparent 65%)",pointerEvents:"none" }} />
        <div style={{ position:"absolute",top:"40%",right:"20%",width:"400px",height:"320px",background:"radial-gradient(ellipse,rgba(139,105,20,.05) 0%,transparent 65%)",pointerEvents:"none" }} />

        {/* eyebrow */}
        <div style={{ display:"inline-flex",alignItems:"center",gap:"8px",padding:"7px 18px",borderRadius:"99px",border:"1px solid rgba(107,26,42,.2)",background:"rgba(107,26,42,.04)",marginBottom:"32px",animation:"sk-slideUp .7s ease both" }}>
        ...
        <h1 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(48px,7vw,88px)",fontWeight:700,color:"#111",lineHeight:1.05,marginBottom:"16px",animation:"sk-slideUp .8s .1s ease both" }}>
          Sanskriti
          <span style={{ display:"block",fontStyle:"italic",background:GRAD,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontWeight:400 }}>The Antique</span>
        </h1>
        ...
        <div style={{ display:"flex",gap:"14px",flexWrap:"wrap",justifyContent:"center",animation:"sk-slideUp 1s .3s ease both" }}>
          <Link href="/register" style={{ padding:"15px 44px",borderRadius:"8px",background:GRAD,color:"#fff",fontSize:"14px",fontWeight:600,letterSpacing:".08em",textDecoration:"none",boxShadow:GRADS }}>
            Join as Seller →
          </Link>
          <Link href="/login" style={{ padding:"15px 36px",borderRadius:"8px",border:"1.5px solid #ddd",color:"#333",fontSize:"14px",fontWeight:500,textDecoration:"none" }}>
            Sign In
          </Link>
        </div>
        ...
        <div style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:"1px",background:"#f0f0f0",borderRadius:"16px",overflow:"hidden",marginTop:"72px",width:"100%",maxWidth:"680px",animation:"sk-slideUp 1s .45s ease both" }}>
          {STATS.map(s => (
            <div key={s.label} style={{ padding:"22px 12px",background:"#fff",textAlign:"center" }}>
              <div style={{ fontFamily:"'Playfair Display',serif",fontSize:"30px",fontWeight:700,background:GRAD,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",lineHeight:1 }}>{s.value}</div>
        ...
        <div style={{ position:"absolute",bottom:"32px",left:"50%",transform:"translateX(-50%)",display:"flex",flexDirection:"column",alignItems:"center",gap:"5px" }}>
          <div style={{ width:"1px",height:"44px",background:`linear-gradient(to bottom,transparent,rgba(107,26,42,.35))` }} />
        ...
        <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:"80px",alignItems:"center" }}>
          <div>
            ...
            <h2 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(32px,4vw,52px)",fontWeight:700,color:"#111",lineHeight:1.1,marginBottom:"18px" }}>
              ...
              <span style={{ display:"block",fontStyle:"italic",background:GRAD,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontWeight:400 }}>An ecosystem.</span>
            </h2>
            ...
            <div style={{ display:"flex",gap:"12px",flexWrap:"wrap" }}>
              <Link href="/register" style={{ padding:"13px 30px",borderRadius:"8px",background:GRAD,color:"#fff",fontSize:"13px",fontWeight:600,textDecoration:"none",boxShadow:"0 6px 20px rgba(107,26,42,.22)" }}>Start Your Journey →</Link>
              <Link href="/services" style={{ padding:"13px 30px",borderRadius:"8px",border:"1.5px solid #ddd",color:"#333",fontSize:"13px",fontWeight:500,textDecoration:"none" }}>See All Services</Link>
            </div>
          </div>
          <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px" }}>
            {[
              ...
              <div key={title} className="sk-feat" style={{ background:"#fafafa",borderRadius:"16px",padding:"22px 18px",border:"1px solid #f0f0f0",transition:"all .25s" }}>
        ...
        <div style={{ maxWidth:"1280px",margin:"0 auto" }}>
          <div style={{ textAlign:"center",marginBottom:"56px" }}>
            ...
            <h2 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(32px,4vw,50px)",fontWeight:700,color:"#111",lineHeight:1.1 }}>
              ...
              <span style={{ display:"block",fontStyle:"italic",fontWeight:400,background:GRAD,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent" }}>Under one roof.</span>
            </h2>
          </div>
          <div style={{ display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:"16px" }}>
            {SERVICES.map((s,i) => (
              <div key={s.title} className="sk-srv" style={{ background:"#fff",borderRadius:"16px",padding:"28px 22px",border:"1px solid #eee",transition:"all .3s ease",animation:vis("srv")?`sk-reveal .5s ${i*0.07}s ease both`:"none" }}>
      ...
      <section ref={secRef("gal")} style={{ padding:"100px 48px",background:"#fff",opacity:vis("gal")?1:0,transform:vis("gal")?"none":"translateY(40px)",transition:"all .7s ease" }}>
        <div style={{ maxWidth:"1280px",margin:"0 auto" }}>
          <div style={{ display:"flex",alignItems:"flex-end",justifyContent:"space-between",marginBottom:"44px",flexWrap:"wrap",gap:"20px" }}>
            <div>
              ...
              <h2 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(30px,4vw,48px)",fontWeight:700,color:"#111",lineHeight:1.1 }}>
                A glimpse of{" "}
                <span style={{ fontStyle:"italic",fontWeight:400,background:GRAD,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent" }}>our collection.</span>
              </h2>
            ...
            {GALLERY_ITEMS.map((item,i) => (
              <div key={item.id} className="sk-gal" onClick={() => setGalleryItem(item)} style={{ borderRadius:"16px",overflow:"hidden",cursor:"pointer",transition:"all .3s ease",boxShadow:"0 2px 12px rgba(0,0,0,.06)",border:"1px solid #f0f0f0",position:"relative",animation:vis("gal")?`sk-reveal .5s ${i*0.07}s ease both`:"none" }}>
                <div style={{ height:"190px",background:item.bg,display:"flex",alignItems:"center",justifyContent:"center",position:"relative" }}>
                  ...
                  {/* hover overlay — burgundy→gold gradient */}
                  <div className="sk-ov" style={{ position:"absolute",inset:0,background:GRAD,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",opacity:0,transition:"opacity .25s ease" }}>
                ...
                <div style={{ padding:"12px 14px",background:"#fff" }}>
                  ...
                  <div style={{ display:"flex",alignItems:"center",gap:"7px" }}>
                    ...
                    <span style={{ fontSize:"10px",padding:"2px 7px",borderRadius:"5px",background:"rgba(107,26,42,.07)",color:BURG,fontWeight:600,border:"1px solid rgba(107,26,42,.15)",fontFamily:"'DM Sans',sans-serif" }}>🔒 Login</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div style={{ marginTop:"32px",padding:"20px 28px",borderRadius:"14px",background:"#fafafa",border:"1px solid #f0f0f0",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"14px" }}>
            ...
            <Link href="/register" style={{ padding:"11px 26px",borderRadius:"8px",background:GRAD,color:"#fff",fontSize:"13px",fontWeight:600,textDecoration:"none",boxShadow:"0 6px 20px rgba(107,26,42,.22)",fontFamily:"'DM Sans',sans-serif" }}>Register to Unlock →</Link>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth:"1280px",margin:"0 auto" }}>
          <div style={{ display:"flex",alignItems:"flex-end",justifyContent:"space-between",marginBottom:"44px",flexWrap:"wrap",gap:"20px" }}>
            <div>
              ...
              <h2 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(30px,4vw,48px)",fontWeight:700,color:"#111",lineHeight:1.1 }}>
                Learn from{" "}
                <span style={{ fontStyle:"italic",fontWeight:400,color:BURG }}>the best.</span>
              </h2>
              <p style={{ fontSize:"15px",color:"#777",marginTop:"10px",fontFamily:"'DM Sans',sans-serif" }}>
          ...
          <div style={{ display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"16px" }}>
            {VIDEOS.map((v,i) => (
              <div key={v.id} className="sk-vid" onClick={() => !v.free && setShowLogin(true)} style={{ background:"#fff",borderRadius:"16px",overflow:"hidden",border:"1px solid #eee",transition:"all .3s ease",cursor:"pointer",animation:vis("vid")?`sk-reveal .5s ${i*0.08}s ease both`:"none" }}>
                <div style={{ height:"140px",background:"#1a0810",display:"flex",alignItems:"center",justifyContent:"center",position:"relative" }}>
                  <div style={{ width:"48px",height:"48px",borderRadius:"50%",background:v.free?BURG:"rgba(255,255,255,.1)",border:"2px solid rgba(255,255,255,.22)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"17px",color:"#fff" }}>
                    {v.free?"▶":"🔒"}
                  </div>
                ...
                <div style={{ padding:"14px 16px" }}>
                  <div style={{ fontSize:"10px",color:BURG,fontWeight:600,letterSpacing:".08em",textTransform:"uppercase",marginBottom:"5px",fontFamily:"'DM Sans',sans-serif" }}>{v.cat}</div>
        ...
        <div style={{ maxWidth:"1280px",margin:"0 auto" }}>
          ...
          <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:"80px",alignItems:"center",marginBottom:"64px" }}>
            <div>
              ...
              <h2 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(32px,4vw,52px)",fontWeight:700,color:"#111",lineHeight:1.1,marginBottom:"18px" }}>
                Everything you need,
                <span style={{ display:"block",fontStyle:"italic",background:GRAD,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontWeight:400 }}>in one place.</span>
              </h2>
              <p style={{ fontSize:"16px",color:"#555",lineHeight:1.85,marginBottom:"14px" }}>
              ...
              <p style={{ fontSize:"16px",color:"#555",lineHeight:1.85,marginBottom:"32px" }}>
                Built for Indian sellers. Compliant, simple, and always up to date.
              </p>
              <div style={{ display:"flex",gap:"12px",flexWrap:"wrap" }}>
                <Link href="/register" style={{ padding:"13px 30px",borderRadius:"8px",background:GRAD,color:"#fff",fontSize:"13px",fontWeight:600,textDecoration:"none",boxShadow:"0 6px 20px rgba(107,26,42,.22)" }}>Get Your Dashboard →</Link>
            ...
            <div style={{ display:"flex",flexDirection:"column",gap:"16px" }}>
              {[
                ...
                <div key={title} style={{ display:"flex",gap:"14px",alignItems:"flex-start",padding:"14px 16px",borderRadius:"12px",border:"1px solid #f0f0f0",background:"#fafafa",transition:"all .2s" }}
                  onMouseEnter={e => { e.currentTarget.style.borderColor="rgba(107,26,42,.2)"; e.currentTarget.style.background="#fff"; e.currentTarget.style.boxShadow="0 4px 16px rgba(107,26,42,.06)"; }}
          ...
          <div style={{ borderRadius:"20px",overflow:"hidden",boxShadow:"0 32px 80px rgba(0,0,0,.12)",border:"1px solid #e8e8e8",position:"relative" }}>
            ...
            <div style={{ background:"#f5f5f5",padding:"10px 16px",borderBottom:"1px solid #e0e0e0",display:"flex",alignItems:"center",gap:"8px" }}>
              ...
              <div style={{ flex:1,background:"#ebebeb",borderRadius:"6px",padding:"4px 12px",fontSize:"11px",color:"#888",fontFamily:"'DM Sans',sans-serif",marginLeft:"8px" }}>
                sanskriti.vyrelle.in/dashboard
              </div>
              <div style={{ display:"flex",alignItems:"center",gap:"6px",padding:"3px 10px",borderRadius:"6px",background:"rgba(107,26,42,.06)",border:"1px solid rgba(107,26,42,.15)" }}>
            ...
            <div style={{ display:"grid",gridTemplateColumns:"200px 1fr",background:"#fff",minHeight:"440px" }}>
              ...
              {/* Sidebar */}
              <div style={{ background:"linear-gradient(180deg,#1a0810 0%,#2d1208 100%)",padding:"20px 0",display:"flex",flexDirection:"column",gap:"2px" }}>
                ...
                {[
                  ...
                  <div key={label} style={{ display:"flex",alignItems:"center",gap:"10px",padding:"9px 16px",margin:"0 8px",borderRadius:"8px",background:active?"rgba(107,26,42,.9)":"transparent",cursor:"default" }}>
              ...
              <div style={{ padding:"24px",background:"#f8f7f5",overflow:"hidden" }}>
                ...
                <div style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:"12px",marginBottom:"18px" }}>
                  {[
                    ["💰","Wallet Balance","₹12,450",  "+₹2,000 today",  "rgba(107,26,42,.08)" ],
                    ["📦","Total Orders",  "48",        "3 pending",      "rgba(107,26,42,.05)"],
                    ["💹","Revenue",       "₹1,84,500", "This month",     "rgba(34,197,94,.08)" ],
                    ["🧾","GST Invoices",  "48",        "All generated",  "rgba(59,130,246,.08)"],
                ...
                <div style={{ background:"#fff",borderRadius:"12px",border:"1px solid #eee",overflow:"hidden" }}>
                  ...
                  {[
                    ["SNK-2605-001","Brass Ganesh Idol",   "Priya Mehta",  "₹4,500","DELIVERED" ],
                    ["SNK-2605-002","Tanjore Painting",    "Arjun Nair",   "₹8,200","SHIPPED"   ],
                    ["SNK-2605-003","Silver Necklace",     "Meera Joshi",  "₹3,100","PENDING"   ],
                    ["SNK-2605-004","Madhubani Art",       "Rohit Gupta",  "₹2,800","CONFIRMED" ],
                  ].map(([id,product,customer,amount,status],i) => {
                    ...
                    return (
                      <div key={id} style={{ display:"grid",gridTemplateColumns:"auto 1fr auto auto",gap:"12px",padding:"10px 16px",borderBottom:i<3?"1px solid #f9f9f9":"none",alignItems:"center" }}>
                        ...
                        <div>
                          <div style={{ fontSize:"11px",fontWeight:600,color:"#111",fontFamily:"'DM Sans',sans-serif" }}>{product}</div>
                          <div style={{ fontSize:"10px",color:"#aaa",fontFamily:"'DM Sans',sans-serif" }}>{customer}</div>
                        </div>
      ...
      <section style={{ background:"#f8f8f8",padding:"0 48px 100px" }}>
        <div style={{ maxWidth:"1280px",margin:"0 auto" }}>
          <div style={{ borderRadius:"20px",background:"#1a0810",padding:"52px 48px",textAlign:"center",position:"relative",overflow:"hidden" }}>
            <div style={{ position:"absolute",inset:0,backgroundImage:"linear-gradient(rgba(107,26,42,.06) 1px,transparent 1px),linear-gradient(90deg,rgba(107,26,42,.06) 1px,transparent 1px)",backgroundSize:"40px 40px",pointerEvents:"none" }} />
            <div style={{ position:"relative" }}>
              ...
              <p style={{ fontSize:"15px",color:"rgba(255,255,255,.5)",maxWidth:"460px",margin:"0 auto 32px",lineHeight:1.8,fontFamily:"'DM Sans',sans-serif" }}>
                Join 5,000+ sellers who have built real businesses with Sanskriti's training and tools.
              </p>
              <div style={{ display:"flex",gap:"14px",justifyContent:"center",flexWrap:"wrap" }}>
                <Link href="/register" style={{ padding:"14px 36px",borderRadius:"8px",background:BURG,color:"#fff",fontSize:"14px",fontWeight:600,letterSpacing:".08em",textDecoration:"none",boxShadow:"0 12px 32px rgba(107,26,42,.45)",fontFamily:"'DM Sans',sans-serif" }}>Register as Seller →</Link>
