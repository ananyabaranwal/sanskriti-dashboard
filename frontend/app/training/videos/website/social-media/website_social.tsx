...
const VIDEOS = [{"id":1,"title":"Instagram Strategy for Antique Sellers","duration":"24:10","desc":"Build an Instagram presence that drives website sales.","free":true},{"id":2,"title":"Creating Reels for Your Antique Business","duration":"18:24","desc":"Shoot and edit professional reels on your phone.","free":false},{"id":3,"title":"Pinterest for Antique Traffic","duration":"22:08","desc":"Use Pinterest to drive long-term website visitors.","free":false},{"id":4,"title":"YouTube Channel Setup and Growth","duration":"31:45","desc":"Start a YouTube channel that positions you as an expert.","free":false},{"id":5,"title":"Content Calendar Planning","duration":"19:33","desc":"Plan 30 days of content in 2 hours.","free":false},{"id":6,"title":"WhatsApp Broadcast for Sellers","duration":"16:38","desc":"Build and leverage a WhatsApp broadcast list of buyers.","free":false}];
    ...
    <div style={{ fontFamily:"'DM Sans',sans-serif",background:"#fff",minHeight:"100vh",paddingTop:"68px" }}>
      ...
      <div style={{ background:BURG,padding:"52px 48px 44px",position:"relative",overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:"900px",margin:"0 auto",position:"relative" }}>
          ...
          <h1 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(28px,4vw,48px)",fontWeight:700,color:"#fff",marginBottom:"10px",lineHeight:1.1 }}>Social Media Content for Website</h1>
          <p style={{ fontSize:"15px",color:"rgba(255,255,255,.7)",fontStyle:"italic",marginBottom:"12px",fontFamily:"'Playfair Display',serif" }}>Build an Audience That Drives Website Sales</p>
          <p style={{ fontSize:"14px",color:"rgba(255,255,255,.65)",lineHeight:1.75,maxWidth:"580px",fontFamily:"'DM Sans',sans-serif",marginBottom:"20px" }}>Create engaging social media content that brings targeted traffic to your antique website.</p>
