...
const VIDEOS = [{"id":1,"title":"Day 1 — Amazon Seller Account Setup","duration":"18:24","desc":"Register, verify, and configure your Amazon seller account.","free":true},{"id":2,"title":"Day 5 — Product Research and Selection","duration":"24:10","desc":"Find winning antique products with high demand and low competition.","free":false},{"id":3,"title":"Day 10 — Amazon-Compliant Photography","duration":"31:45","desc":"Meet Amazon image requirements and stand out.","free":false},{"id":4,"title":"Day 15 — Listing Optimisation and Keywords","duration":"22:08","desc":"Write titles, bullets, and descriptions that rank on Amazon.","free":false},{"id":5,"title":"Day 20 — FBA vs FBM","duration":"19:33","desc":"Decide the right fulfilment strategy for antique products.","free":false},{"id":6,"title":"Day 30 — Amazon PPC Advertising Basics","duration":"28:17","desc":"Run your first Sponsored Products campaign profitably.","free":false},{"id":7,"title":"Day 45 — Managing Reviews and Claims","duration":"26:52","desc":"Handle reviews, complaints, and Amazon A-to-Z claims.","free":false},{"id":8,"title":"Day 60 — Advanced PPC and ACoS Reduction","duration":"23:06","desc":"Scale your ads while reducing advertising cost of sales.","free":false},{"id":9,"title":"Day 75 — Scaling to Top 100 Seller","duration":"35:20","desc":"The exact strategies to hit Rs.5L+ monthly on Amazon.","free":false}];
      ...
      <div style={{ background:BURG,padding:"52px 48px 44px",position:"relative",overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:"900px",margin:"0 auto",position:"relative" }}>
          <div style={{ display:"flex",gap:"6px",alignItems:"center",marginBottom:"16px",flexWrap:"wrap" }}>
            ...
            <span style={{ color:"rgba(255,255,255,.3)" }}>›</span>
            <Link href="/training/videos/amazon" style={{ fontSize:"12px",color:"rgba(255,255,255,.55)",textDecoration:"none" }}>Amazon</Link>
            <span style={{ color:"rgba(255,255,255,.3)" }}>›</span>
            <span style={{ fontSize:"12px",color:"rgba(255,255,255,.9)" }}>75 Days Training</span>
          </div>
          <h1 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(28px,4vw,48px)",fontWeight:700,color:"#fff",marginBottom:"10px",lineHeight:1.1 }}>75 Days Amazon Training</h1>
          <p style={{ fontSize:"15px",color:"rgba(255,255,255,.7)",fontStyle:"italic",marginBottom:"12px",fontFamily:"'Playfair Display',serif" }}>From Account Setup to Top-Rated Amazon Seller</p>
          <p style={{ fontSize:"14px",color:"rgba(255,255,255,.65)",lineHeight:1.75,maxWidth:"580px",fontFamily:"'DM Sans',sans-serif",marginBottom:"20px" }}>Master the complete Amazon seller journey in 75 days — the exact playbook our top Amazon sellers follow.</p>
          <div style={{ display:"flex",gap:"10px",flexWrap:"wrap" }}>
            <div style={{ padding:"5px 14px",borderRadius:"99px",background:"rgba(255,255,255,.12)",border:"1px solid rgba(255,255,255,.2)",fontSize:"12px",color:"#fff",fontFamily:"'DM Sans',sans-serif" }}>75 days · 9 videos</div>
            ...
            <div style={{ padding:"5px 14px",borderRadius:"99px",background:"rgba(255,255,255,.08)",border:"1px solid rgba(255,255,255,.15)",fontSize:"12px",color:"rgba(255,255,255,.7)",fontFamily:"'DM Sans',sans-serif" }}>🔒 8 Seller Only</div>
          </div>
        </div>
      </div>
      {!isLoggedIn && (
        <div style={{ background:"#fff3f4",borderBottom:"1px solid rgba(155,0,32,.15)",padding:"12px 48px" }}>
          <div style={{ maxWidth:"900px",margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",gap:"16px",flexWrap:"wrap" }}>
            <div style={{ fontSize:"13px",color:BURG,fontFamily:"'DM Sans',sans-serif" }}>🔒 <strong>8 videos locked.</strong> Sign in to unlock.</div>
      ...
      <div style={{ maxWidth:"900px",margin:"0 auto",padding:"48px 48px 80px" }}>
        ...
        {!isLoggedIn && (
          <div style={{ marginTop:"48px",padding:"40px",borderRadius:"16px",background:BURG,textAlign:"center" }}>
            <h3 style={{ fontFamily:"'Playfair Display',serif",fontSize:"24px",fontWeight:700,color:"#fff",marginBottom:"10px" }}>Unlock All 8 Videos</h3>
