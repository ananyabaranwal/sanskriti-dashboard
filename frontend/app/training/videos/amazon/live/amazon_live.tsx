...
const VIDEOS = [{"id":1,"title":"Live Session 1 — Account Health Review","duration":"60:00","desc":"Live audit of participant accounts with expert feedback.","free":true},{"id":2,"title":"Live Session 2 — PPC Masterclass","duration":"90:00","desc":"Live campaign building and optimisation — hands on.","free":false},{"id":3,"title":"Live Session 3 — Listing Teardown","duration":"75:00","desc":"Expert review of real antique listings — what works, what does not.","free":false},{"id":4,"title":"Live Session 4 — FBA Deep Dive","duration":"60:00","desc":"Fulfilment strategy, inventory planning, and fee calculation.","free":false},{"id":5,"title":"Live Session 5 — Q&A with Amazon Experts","duration":"90:00","desc":"Open Q&A with sellers doing Rs.1Cr+ on Amazon annually.","free":false}];
    ...
    <div style={{ fontFamily:"'DM Sans',sans-serif",background:"#fff",minHeight:"100vh",paddingTop:"68px" }}>
      ...
      <div style={{ background:BURG,padding:"52px 48px 44px",position:"relative",overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:"900px",margin:"0 auto",position:"relative" }}>
          ...
          <h1 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(28px,4vw,48px)",fontWeight:700,color:"#fff",marginBottom:"10px",lineHeight:1.1 }}>Live Amazon Training</h1>
          <p style={{ fontSize:"15px",color:"rgba(255,255,255,.7)",fontStyle:"italic",marginBottom:"12px",fontFamily:"'Playfair Display',serif" }}>Real-Time Coaching from Top Amazon Sellers</p>
          <p style={{ fontSize:"14px",color:"rgba(255,255,255,.65)",lineHeight:1.75,maxWidth:"580px",fontFamily:"'DM Sans',sans-serif",marginBottom:"20px" }}>Live coaching sessions where Amazon experts review your listings and help you grow sales in real time.</p>
