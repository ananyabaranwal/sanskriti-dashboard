...
const VIDEOS = [{"id":1,"title":"Why Social Media Matters for Amazon","duration":"18:24","desc":"How external traffic boosts your Amazon rank and BSR.","free":true},{"id":2,"title":"Instagram Shop Setup for Amazon Sellers","duration":"24:10","desc":"Link Instagram to drive direct Amazon sales.","free":false},{"id":3,"title":"Unboxing Videos That Convert","duration":"22:08","desc":"Create unboxing content that builds trust and drives reviews.","free":false},{"id":4,"title":"Influencer Collaborations on a Budget","duration":"19:33","desc":"Partner with micro-influencers to boost your Amazon listings.","free":false},{"id":5,"title":"Facebook Groups for Antique Sellers","duration":"16:38","desc":"Use communities to find buyers and build your brand.","free":false},{"id":6,"title":"Building a Brand Beyond Amazon","duration":"28:17","desc":"Why and how to build a brand that survives algorithm changes.","free":false}];
      ...
      <div style={{ background:BURG,padding:"52px 48px 44px",position:"relative",overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:"900px",margin:"0 auto",position:"relative" }}>
          <div style={{ display:"flex",gap:"6px",alignItems:"center",marginBottom:"16px",flexWrap:"wrap" }}>
            ...
            <span style={{ color:"rgba(255,255,255,.3)" }}>›</span>
            <span style={{ fontSize:"12px",color:"rgba(255,255,255,.9)" }}>Social Media Content</span>
          </div>
          <h1 style={{ fontFamily:"'Playfair Display',serif",fontSize:"clamp(28px,4vw,48px)",fontWeight:700,color:"#fff",marginBottom:"10px",lineHeight:1.1 }}>Social Media Content for Amazon</h1>
          <p style={{ fontSize:"15px",color:"rgba(255,255,255,.7)",fontStyle:"italic",marginBottom:"12px",fontFamily:"'Playfair Display',serif" }}>Drive External Traffic to Boost Your Amazon Rank</p>
          <p style={{ fontSize:"14px",color:"rgba(255,255,255,.65)",lineHeight:1.75,maxWidth:"580px",fontFamily:"'DM Sans',sans-serif",marginBottom:"20px" }}>Build a social media presence that sends external traffic to your Amazon listings and improves your BSR.</p>
          <div style={{ display:"flex",gap:"10px",flexWrap:"wrap" }}>
            <div style={{ padding:"5px 14px",borderRadius:"99px",background:"rgba(255,255,255,.12)",border:"1px solid rgba(255,255,255,.2)",fontSize:"12px",color:"#fff",fontFamily:"'DM Sans',sans-serif" }}>6 modules · 20+ videos</div>
            ...
            <div style={{ padding:"5px 14px",borderRadius:"99px",background:"rgba(255,255,255,.08)",border:"1px solid rgba(255,255,255,.15)",fontSize:"12px",color:"rgba(255,255,255,.7)",fontFamily:"'DM Sans',sans-serif" }}>🔒 5 Seller Only</div>
          </div>
        </div>
      </div>
      {!isLoggedIn && (
        <div style={{ background:"#fff3f4",borderBottom:"1px solid rgba(155,0,32,.15)",padding:"12px 48px" }}>
          <div style={{ maxWidth:"900px",margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",gap:"16px",flexWrap:"wrap" }}>
            <div style={{ fontSize:"13px",color:BURG,fontFamily:"'DM Sans',sans-serif" }}>🔒 <strong>5 videos locked.</strong> Sign in to unlock.</div>
      ...
      <div style={{ maxWidth:"900px",margin:"0 auto",padding:"48px 48px 80px" }}>
        ...
        {!isLoggedIn && (
          <div style={{ marginTop:"48px",padding:"40px",borderRadius:"16px",background:BURG,textAlign:"center" }}>
            <h3 style={{ fontFamily:"'Playfair Display',serif",fontSize:"24px",fontWeight:700,color:"#fff",marginBottom:"10px" }}>Unlock All 5 Videos</h3>
